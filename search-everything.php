<?php
/*
Plugin Name: Search Everything - Preliminary Version for PHP7.2
Description: "Search Everything" (http://wordpress.org/plugins/search-everything/) is modified in order to remove the function "create_function" which is deprecated since PHP 7.2.
Version: 8.1.9.1
Author: Yusuke Manabe
GitHub Plugin URI: https://github.com/Yusuke-Manabe/wp-search-everything-PHP7.2
GitHub Branch:     master
*/

define('SE_VERSION', '8.1.9.1');
